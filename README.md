...
#### ☕ Backend & Core
💾 `Java 11 / 17` · `Spring Boot` · `Spring Framework` · `Spring Security` · `Hibernate ORM` · `REST APIs` · `WebSocket` · `JWT`

#### 🌐 Frontend & UI
🎨 `JavaScript` · `TypeScript` · `React` · `Redux` · `HTML5 / CSS3`

#### 🗄️ Databases & Messaging
📊 `PostgreSQL` · `MongoDB` · `Apache Kafka` · `RabbitMQ` · `SQL`

#### ☁️ DevOps, Cloud & Tools
🚀 `AWS (EC2, S3, RDS)` · `Docker` · `Kubernetes` · `Git` · `Maven` · `Gradle` · `Jira Plugin Development`
